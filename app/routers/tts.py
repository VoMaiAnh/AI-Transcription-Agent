...
Handles text-to-speech synthesis using OmniVoice
"""
...
async def synthesize_tts_info():
    ...
    return {
        ...
        "backend": {
            "omnivoice": "Install with: pip install -r requirements.txt. Use instruction for voice-design attributes such as 'female, low pitch, british accent'.",
        },
...
async def synthesize_tts(
    ...
    instruction: Optional[str] = Form(None, description="Optional natural-language style/instruction prompt"),
